# Assignment3
![alt text](https://github.com/dsample001/CPSC4970-Project6/blob/main/Docs/banner_au.png)?raw=true)

✅ `Complete` <br/>
❕'Finished Project' (Kind of Sort of Maybe")

# Assignment 3

This is Project 6 for CPSC-4970 Python for Daniel Sample.
