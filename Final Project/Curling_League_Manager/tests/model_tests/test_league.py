...
from Curling_League_Manager.model.competition import Competition
...
class LeagueTests(unittest.TestCase):
    ...
    def test_adding_team_with_same_oid_throws_duplicateoid(self):
        t1 = Team(1, "Ice Maniacs")
        t2 = Team(1, "Not Ice Maniacs")
        league = League(1, "AL State Curling League")
        league.add_team(t1)
        self.assertRaises(DuplicateOid, league.add_team, t2)
    ...
    def test_adding_competition_that_both_teams_are_in_league(self):
        t1 = Team(1, "Ice Maniacs")
        t2 = Team(2, "Not Ice Maniacs")
        league = League(1, "AL State Curling League")
        league.add_team(t1)
        c = Competition(1, [t1, t2], "Local tourney", None)

        self.assertRaises(ValueError, league.add_competition, c)
        league.add_team(t2)
        self.assertNotIn(c, league.competitions)
        league.add_competition(c)
        self.assertIn(c, league.competitions)
    ...
    def test_remove_team_with_competition_throws_value_error(self):
        t1 = Team(1, "Ice Maniacs")
        t2 = Team(2, "Not Ice Maniacs")
        league = League(1, "AL State Curling League")
        league.add_team(t1)
        ...
        c = Competition(1, [t1, t2], "Local tourney", None)
        league.add_competition(c)
        self.assertRaises(ValueError, league.remove_team, t1)
